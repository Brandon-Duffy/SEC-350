...
interfaces {
    ethernet eth0 {
        address 10.0.17.117/24
        description SEC350-WAN
        hw-id 00:50:56:a1:0f:fe
    }
    ethernet eth1 {
        address 172.16.50.2/29
        description BRANDON-DMZ
        hw-id 00:50:56:a1:7b:2c
    }
    ethernet eth2 {
        address 172.16.150.2/24
        description BRANDON-LAN
        hw-id 00:50:56:a1:06:c7
    }
    loopback lo {
    }
}
nat {
    ...
    source {
        rule 10 {
            description "NAT FROM DMZ TO LAN"
...
system {
    ...
    host-name fw01-brandon
    login {
        user vyos {
            authentication {
                encrypted-password $6$wIQsybTeh/Xkt/Sk$YB9XPNm0g3XDyQZlZMUs6QqC7jPd4.k45bsvCSkUnHdMX/HZelZiguaz8mJuZQavrUelafWlXyXkie.JaJAGb0
            }
        }
    }
